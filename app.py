...
header{background:var(--bg3);border-bottom:1px solid var(--border);padding:6px 12px;
  display:flex;align-items:center;justify-content:space-between;flex-wrap:nowrap;gap:8px;min-height:0}
h1{font-size:13px;color:#e8f0f8;letter-spacing:-.5px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.sub{display:none}
.hright{display:flex;align-items:center;gap:8px;flex-wrap:nowrap;flex-shrink:0}
.sp{display:none}
.sp{display:none}#station-btns{display:none}
