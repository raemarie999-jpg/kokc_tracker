...
window.onerror = function(msg,src,line,col,err){ document.getElementById("stxt").textContent="ERR L"+line+": "+msg; return false; };
document.getElementById("page-title").textContent = STATION + " \u00b7 Model Tracker";
document.getElementById("page-sub").textContent = STATION_NAMES[STATION] || STATION;
try{ buildForms(); buildDefaultForm(); renderPreview(); poll(); startCountdown(); } catch(e){ document.getElementById("stxt").textContent="INIT ERR: "+e.message; }
